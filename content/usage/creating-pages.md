...
Creating pages in Lookup is as simple as creating a Markdown file (`.md`) with your favorite text editor.
...
`.md` files within the `content` folder (or sub-folders) will be recognized.
...
category in Lookup. You can create as many levels of sub-folder as you like but they will always appear
...
Below is a table of example folder and file names and the URL's they would have in Lookup.
